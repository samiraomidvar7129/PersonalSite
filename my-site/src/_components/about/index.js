...
const AboutComp=()=>{
    return(
        ...
        <div className=" w-[75%] mx-auto py-5 flex flex-col justify-center items-start">
            <div className="px-5 ">
              <div className="mt-5">
                <h6 className='font-bold text-white'>Who I Am</h6>
              </div>
              <div  className=" mt-4">
                <p className="text-sm leading-[32px] text-white">
